...
return [
  ...
  //This is reserved key name. DO NOT OVERWRITE
  ...
  |--------------------------------------------------------------------------
  |
  | This is where you should define all your Local Classes, Models, Third-party application (See Vendor prefix below), etc.
